            ...
            <div className='container proy'>
                ...
                <div  >
                    ...
                    <div className='container proj'>
                        ...
                        <h5>This is Rolling Code final project. It's a restaurant menu. It was made using stack MERN.(MongoDB, Express, Reat and Node)</h5>
                        <a className='linkss' href="https://bigburger-front.herokuapp.com">View App</a>
                    </div>
                    <div className='container proj'>
                        <h2><b>Movie Pop</b></h2>
                        <h5>This is a personal project. It's a movies platform. It was made using stack MERN.(MongoDB, Express, Reat and Node) </h5>
