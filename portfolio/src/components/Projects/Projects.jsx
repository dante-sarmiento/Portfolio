        ...
        <>
            ...
            <div className='container proy'>
                    <div className='container proj'>
                        ...
                        <div className='linki'>
                            <a className='linkss' href="https://ontherocks1.netlify.app/"><em>View App</em></a>
                        </div>
                    </div>
                    <div className='container proj'>
                        <h2><b>Gamer Guy</b></h2>
                        ...
                        <div className='linki'>
                            <a className='linkss' href="https://gamerguy.netlify.app/pages/login/login.html"><em>View App</em></a>
                        </div>
                    </div>
                    <div className='container proj'>
                        ...
                        <div className='linki'>
                            <a className='linkss' href="https://bigburger-front.herokuapp.com"><em>View App</em></a>
                        </div>
                    </div>
                    <div className='container proj'>
                        <h2><b>Movie Pop</b></h2>
                        ...
                        <div className='linki'>
                            <a className='linkss' href="https://app-moviepop-fronted.herokuapp.com"><em>View App</em></a>
                        </div>
